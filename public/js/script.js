!function() {
    ...
    (t => {
        ...
        const f = "data-",
              ...
              E = () => i && i.getItem("umami.disabled") || v && !S.includes(s),
              L = async (t, e = "event") => {
                  if (E()) return;
              ...
              $ = (t, e) => L("string" == typeof t ? { ...j(), name: t, data: "object" == typeof e ? e : void 0 } : "object" == typeof t ? t : "function" == typeof t ? t(j()) : j()),
                ...
                if (!i) return a(r);
                {
                    ...
                    if (c)
                        if ("A" === i.tagName) {
                            ...
                            if (c && e) return o || t.preventDefault(), a(i).then((() => { o || (n.href = e) }))
                        } else if ("BUTTON" === i.tagName) return a(i)
                }
            }), !0);
            const t = () => { "complete" !== c.readyState || R || ($(), R = !0) };
